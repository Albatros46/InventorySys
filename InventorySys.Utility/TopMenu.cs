...
namespace InventorySys.Utility
{
    public static class TopMenu
    {
        ...
        public static class RecievedNote
        {
            public const string PageName = "RecievedNote";
            public const string RoleName = "RecievedNote";
            public const string Path = "/RecievedNote/Index";
            public const string ControllerName = "RecievedNote";
            public const string ActionName = "Index";
        }
